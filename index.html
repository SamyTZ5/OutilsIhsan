...
<title>Calculateur Zakât - Institut Ihsan</title>
...
<header class="site-header">
    <div class="header-content">
        ...
        <h1 class="site-title">CALCULATEUR DE ZAKÂT</h1>
    ...
    <div class="content-area">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div id="historicalAlert" class="alert-box">
                    ⚠ <strong>Date passée détectée :</strong> Le système ne récupère automatiquement que le cours du jour. 
                    Pour une date antérieure, veuillez saisir manuellement les cours.<br>
                ...
                <div class="form-group">
                    <div class="label-col">
                        <span class="label-main">Prix du gramme d'Argent (€)</span>
                        <span class="label-sub">Seuil Nisâb = 595g d'argent</span>
                    </div>
                    <div class="input-col">
                ...
                <div class="form-group">
                    <div class="label-col">
                        <span class="label-main">Prix du gramme d'Or (€)</span>
                        <span class="label-sub">Référence patrimoine Or</span>
                    </div>
                    <div class="input-col">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <div class="label-col">
                        <span class="label-main" style="color:var(--c-danger);">Dettes immédiates</span>
                        <span class="label-sub">Factures, loyers dus, mensualités à régler ce mois-ci.</span>
                    </div>
                    <div class="input-col">
    ...
    <aside class="sidebar">
        <div class="card summary-card">
            <div class="summary-header">
                <h3 class="summary-title">Synthèse</h3>
            </div>
            <div class="summary-body">
                ...
                <div style="background:rgba(197,160,101,0.1); border:1px solid rgba(197,160,101,0.4); padding:15px; border-radius:6px; text-align:center; margin-bottom:30px;">
                    <span class="val" id="nisabDisplay" style="display:block; color:var(--c-gold); font-family:'Playfair Display', serif; font-size:1.5rem;">0,00 €</span>
                    <span class="lbl" style="color:#aaa; font-size:0.7rem; text-transform:uppercase;">Seuil Nisâb (Argent 595g)</span>
                </div>

                <div class="summary-row"><span>Total Actifs</span><span id="resAssets">0,00 €</span></div>
                <div class="summary-row"><span>Dettes</span><span id="resDebts" style="color:#e74c3c;">- 0,00 €</span></div>
                <div class="summary-row net-asset-row"><span>Assiette Zakatable</span><span id="resNet">0,00 €</span></div>
                ...
                <div class="final-box" id="finalBox">
                    <span class="amount" id="zakatAmount">0 €</span>
                    <span class="label">Zakât à payer (2.5%)</span>
                </div>

                <div class="actions-area">
                    <button class="btn-action btn-excel" onclick="exportToExcelPro()">📥 Export Excel</button>
                    <button class="btn-action btn-reset" onclick="resetAll()">↻ Remise à zéro</button>
                </div>
            </div>
        </div>
    </aside>
...
<script>
    ...
    function calculate() {
        ...
        if (net >= nisab && nisab > 0) {
            statusBox.style.display = 'block'; statusBox.style.background = 'rgba(46, 204, 113, 0.1)'; statusBox.style.color = '#27ae60'; statusBox.innerHTML = "✔ Nisâb atteint";
            document.getElementById('zakatAmount').innerText = fmt.format(net * 0.025);
            document.getElementById('finalBox').style.opacity = '1';
        } else {
            statusBox.style.display = 'block'; statusBox.style.background = 'rgba(231, 76, 60, 0.1)'; statusBox.style.color = '#c0392b'; statusBox.innerHTML = "✖ Nisâb non atteint";
